...
@section('content')
            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        ...
                        <a href="{{ url('products') }}" class="btn-link">Shop Now</a>
                    </div>
                </div>
                <div class="item-slide">
        ...
        <div class="wrap-banner style-twin-default">
            <div class="banner-item">
                <a href="{{ url('products') }}" class="link-banner banner-effect-1">
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                ...
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{ url('product/'. $sale->slug ) }}" title="{{  $sale->name }}">
                            <figure><img src="{{  $sale->image }}" width="800" height="800" ></figure>
                        </a>
                    ...
                    <div class="product-info">
                        <a href="{{ url('product/'. $sale->slug ) }}" class="product-name"><span>{{  $sale->name }}</span></a>
                        <div class="wrap-price"><span class="product-price">${{  $sale->price }}</span></div>
                    </div>
                </div>
                    @endforeach
                @endif
        ...
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box"> {{ Custom::uppercase('Latest Products') }}</h3>
            <div class="wrap-top-banner">
                <a href="{{ url('product/' ) }}" class="link-banner banner-effect-2">
                    ...
                    <div class="tab-contents">
                        <div class="tab-content-item active" id="digital_1a">
                            ...
                            @if($latest)
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ url('product/'. $single->slug ) }}" title="{{ $single->name }}">
                                            <figure><img src="{{ $single->image }}" width="800" height="800" ></figure>
                                        </a>
                                        <div class="group-flash">
                                            <span class="flash-item new-label">new</span>
                                        </div>
                                        <div class="wrap-btn">
                                            <a href="{{ url('product/'. $single->slug ) }}" class="function-link">quick view</a>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ url('product/'. $single->slug ) }}" class="product-name"><span>{{ $single->name }}</span></a>
                                        <div class="wrap-price"><span class="product-price">${{ $single->price }}</span></div>
                                    </div>
                                </div>
                                @endforeach
                            @endif
